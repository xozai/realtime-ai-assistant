...
The README is current through **v0.18.1**, including the Sprint 3 feature set: configurable story-generation models, Jira dry-run and partial-failure reporting, selective story refinement, and Server-Sent Events dashboard updates. See `CHANGELOG.md` for the release-by-release history generated by release-please.
